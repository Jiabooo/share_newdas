...
def locate_people(ori_x, ori_y, img, new_x, new_y,windows_num_x,windows_num_y,for_low_limit,for_dis, down):
    # 滑动窗口定位
    # windows_num_x = 1
    # windows_num_y = 1
    # windows_num_x = 2
...
# gt
img_position = locate_people(img_position.shape[0],  img_position.shape[0], temp_1, img_position.shape[0], img_position.shape[1], x,y,low,dist, 1)
