...
checkpoint = torch.load(r"D:\renqun\share_newdas\das\mask_depth2\mask_depth.tar")
model.load_state_dict(checkpoint['state_dict'])


num = 119
img = r"D:\renqun\share_newdas\das\shanghai\part_A_final/test_data/images/IMG_{}.jpg".format(num)
